...
import sleepPodcast2 from '../assets/anime/sleepPodcast2.json'

const ListenPodcasts = () => {

  const audioFiles = [
    { title: `Sleep Hypnosis`, uri: `https://res.cloudinary.com/ddhgokvc1/video/upload/v1697899302/Sleepy/PodCasts/podcast1_gspz7e.mp3`, src: `${sleepPodcast2}` },
