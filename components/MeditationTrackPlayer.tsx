...
import womenMeditate from '../assets/anime/womenMeditate.json'

const MeditationTrackPlayer = () => {

    const audioFiles = [
        { title: `10-Minute Meditation For Sleep`, uri: `https://res.cloudinary.com/ddhgokvc1/video/upload/v1697880636/Sleepy/meditation/10-Minute_Meditation_For_Sleep_ec06bv.mp3`, src: `${womenMeditate}` },
    ...
    return (
        <View style={styles.container}>
            <View style={styles.album}>
                <Text style={styles.albumTitle}>Meditation Playlists</Text>
                {/* {
...
export default MeditationTrackPlayer
